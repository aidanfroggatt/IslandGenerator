...
public class LagoonSpecification implements Buildable {
    ...
    public Mesh build(Mesh inputMesh) {
        ...
        process(polygonList, vertices, new double[]{inputMesh.getWidth(), inputMesh.getHeight(), circleRadius / 2}, null, TileType.LAGOON);
